...
namespace vildanbina\Duplicate\Traits;
...
use vildanbina\Duplicate\Helpers\RelationHelper;
...
trait HasDuplicates
{
     ...
     * Options can be viewed in the vildanbina\Duplicate\Options\DuplicateOptions file.
     *
